...
let CartEntity = class CartEntity {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, product: { required: true, type: () => require("../../product/entities/product.entity").ProductEntity }, quantity: { required: true, type: () => Number } };
    }
};
